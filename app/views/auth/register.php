    ...
    <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md w-full max-w-md">
        ...
        <form action="<?php echo BASE_URL; ?>/register" method="POST">
            ...
            <div class="flex items-center justify-between">
                <button type="submit" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline dark:bg-green-600 dark:hover:bg-green-800">
                    Register
                </button>
                <a href="<?php echo BASE_URL; ?>/login" class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-600">
                    Login
                </a>
            </div>
        </form>
